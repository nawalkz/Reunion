                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Mettre a jour d'une notification</h3>
                        </div>
                        @php
                        ...
                        <div class="card-body">
                            <form action="{{ route('notifications.update', $notification->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="date">lu</label>
                                    <input type="text" class="form-control" id="lu" name="lu" value="{{ $notification->lu}}" required>
                                </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select class="form-control" id="reunion_id" name="reunion_id" required>
                                        @foreach ($reunions as $reunion)
                                            <option value="{{ $reunion->id }}" {{ $reunion->id == $reunion->reunion_id ? 'selected' : '' }}>{{ $reunion->titre }}</option>
                                        @endforeach
                                    </select>
                                </div>
